...
const ProtectedRoute = ({ children }) => {
  ...
  if (loading) {
     return <div className="page-content" style={{textAlign:'center', padding:'20px'}}>Cargando sesión...</div>;
  }
...
export default function App() {
  return (
    <div style={{maxWidth:'480px', margin:'0 auto', paddingBottom:'70px'}}>
      <Routes>
        {/* RUTAS PÚBLICAS ESENCIALES */}
